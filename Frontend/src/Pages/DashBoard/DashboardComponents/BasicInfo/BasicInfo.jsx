...
export const BasicInfoForm = ({ dashboardData }) => {
    ...
    let [formData, setFormData] = useState({
        banner: dashboardData.bannerUrl || null,
        tagline: dashboardData.tagline || "",
        about: dashboardData.about || "",
        aboutImg: dashboardData.aboutImgUrl || null
    });
    ...
    const [preview, setPreview] = useState({
        banner: dashboardData.bannerUrl || "https://images.pexels.com/photos/18272659/pexels-photo-18272659.jpeg",
        aboutImg: dashboardData.aboutImgUrl || "https://images.pexels.com/photos/18272659/pexels-photo-18272659.jpeg"
    });
                    ...
                    <div className="aboutTextareaAndImg">
                        ...
                        <label className="AboutImgAndUpload">
                            <input
                                type="file"
                                id="hiddenFileField"
                                onChange={(e) => { handleFileUpload(e.target.files[0], "aboutImg") }}
                            />
                            <img src={preview.aboutImg} alt="Insert Image" className="aboutusImg" />
