                    ...
                    <tr className="SA_table_row" key={i}>
                        ...
                        <td>
                            <div className="SA_contact_stack">
                                <div className="SA_contact_item"><FiMail /> <span>{biz.adminEmail || biz.email}</span></div>
                                <div className="SA_contact_item"><FiPhone /> <span>{biz.phone || biz.phonenumber}</span></div>
