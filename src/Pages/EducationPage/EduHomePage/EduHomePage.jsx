                        ...
                        <>
                            <section className="edu-pg-grd-sec">
                                ...
                                <div className="content-cont">
                                    ...
                                    <p className="pg-desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium velit recusandae esse ipsum, enim inventore nihil nam beatae, corporis in quidem provident repellendus omnis ex quis sit hic, non qui. Praesentium velit recusandae esse ipsum, enim inventore nihil nam beatae.<em className="rgstr" onClick={() => { setShowform(true) }}> Register yourself here</em></p>
