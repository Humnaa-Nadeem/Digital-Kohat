...
// IMPORT GARDENING & OUTDOOR STORE
import { GO_ExpertCrdDta, GO_ExpertDetails, GardeningOutdoorExperts } from "../../../Store/Techcn_Store";

export const GardOutdoorCata = () => {
    ...
    let [Crdsdta, setCrdsdta] = useState(GO_ExpertCrdDta);
            ...
            <main>
                <section className="Tech-Cata-Pg-Sec">
                    ...
                    <div className="Tech-cata-pg-banner">
                        <h1 className="tech-cata-h1">Find Gardening & Outdoor Experts</h1>
                        <p className="tech-cata-p">
                            Professional gardening and outdoor landscaping services at your doorstep.
                        </p>

                        <SearchBar SearchedInst={setCrdsdta} AllInst={GO_ExpertCrdDta} />
                    ...
                    <div className="tech-cata-fltr-crdsCont">
                        ...
                        <div className={showList ? "tech-cata-fltr display" : "tech-cata-fltr"}>
                            ...
                            <ul className="list">
                                {GardeningOutdoorExperts.map((v, i) => (
                                    <li key={i} onClick={() => { navigate(`/tech/gard-outdoor?id=${v.id}`); setShowlist(false); }}>
                                        {v.ExpertName}
                                    </li>
                                ))}
                                <li onClick={() => { navigate("/tech/gard-outdoor"); setShowlist(false); }}>Back To Cards</li>
                        ...
                        <div className="tech-cata-crdCont">
                            ...
                            {id ? (
                                // -------------------- DETAILS PAGE --------------------
                                GO_ExpertDetails.filter(v => v.id === Number(id)).map((v, i) => (
                                    <div className="resume-box" key={i}>
                                        <div>
                                            <img src={v.img} alt="Profile" className="profile-img" />
                                            <h1>{v.Title}</h1>
                                            <div className="role">Professional Gardening & Outdoor Expert</div>
                                        </div>
                                ...
                                <div className="cata-card-cont">
                                    {Crdsdta.map((v, i) => (
                                        <div className="cata-pg-card" key={i}>
                                            <img src={v.img} alt="Gardening Expert" />
                                            <div className="cata-pg-card-content">
                                                <h3>{v.InstName}</h3>
                                                <p>{v.Desc}</p>
                                                <button
                                                    className="cata-pg-card-btn"
                                                    onClick={() => navigate(`/tech/gard-outdoor?id=${v.id}`)}
                                                >
                                                    {v.btn_txt}
                                                </button>
                                            </div>
